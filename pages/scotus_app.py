...
SCOTUS Legal Aid — main research page. Entry point is app.py (navigation
router); this file contains all app logic and UI.
...
def handle_comparative(question: str, case_metadata: dict) -> dict:
    ...
    # 4a -- FAISS-first semantic search to identify relevant cases.
    ...
    # without this, a long opinion with many chunks structurally dominates
    # hit_count over a short, single-opinion case regardless of relevance.
    case_chunk_counts = {}
...
st.caption("Retrieval-augmented Q&A over 19 indexed U.S. Supreme Court opinions.")
...
with _hero_left:
    ...
    st.markdown("""
- AI-powered legal research over 19 indexed U.S. Supreme Court opinions
